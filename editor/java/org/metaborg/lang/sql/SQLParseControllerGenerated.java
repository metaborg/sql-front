...
public class SQLParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("SQL");
  ...
  { 
    SQLParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = SQLParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = SQLParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(SQLParseControllerGenerated.class);
    }
  ...
  { 
    return SQLParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
